...
static char RcsId[] = "@(#)$Header: /home/srilm/devel/lattice/src/../../misc/src/RCS/File.cc,v 1.13 2009/01/20 19:42:15 stolcke Exp $";
#endif
...
#include <stdio.h>
#include <assert.h>
#if defined(sgi) || defined(_MSC_VER) || defined(WIN32) || defined(linux) && __INTEL_COMPILER<=700
#define fseeko fseek
#define ftello ftell
#endif
