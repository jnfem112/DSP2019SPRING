...
#
# $Header: /home/srilm/devel/utils/src/RCS/make-google-ngrams.gawk,v 1.5 2009/11/19 00:33:26 stolcke Exp $
#
...
END {
    ...
    if (have_dir[1]) {
	system("gunzip -f < " dir "/1gms/vocab" gzip_suff " | sort -k 2,2rn | " gzip_cmd " > " dir "/1gms/vocab_cs" gzip_suff);
    }
}
