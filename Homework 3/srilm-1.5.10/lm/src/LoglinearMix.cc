...
static char RcsId[] = "@(#)$Header: /home/srilm/devel/lm/src/RCS/LoglinearMix.cc,v 1.6 2007/12/29 17:52:37 stolcke Exp $";
#endif
...
LoglinearMix::LoglinearMix(Vocab &vocab, Array<LM *> &subLMs,
							Array<Prob> &priors)
    : LM(vocab), subLMs(subLMs), priors(priors), numLMs(subLMs.size())
{
}
