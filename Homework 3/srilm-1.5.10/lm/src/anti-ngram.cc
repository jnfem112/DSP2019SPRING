...
#ifndef lint
static char Copyright[] = "Copyright (c) 1999-2008 SRI International.  All Rights Reserved.";
static char RcsId[] = "@(#)$Id: anti-ngram.cc,v 1.18 2008/04/24 19:34:03 stolcke Exp $";
#endif
