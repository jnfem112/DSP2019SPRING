...
#ifndef lint
static char Copyright[] = "Copyright (c) 2002-2008 SRI International.  All Rights Reserved.";
static char RcsId[] = "@(#)$Id: nbest-pron-score.cc,v 1.10 2008/04/24 19:34:03 stolcke Exp $";
#endif
