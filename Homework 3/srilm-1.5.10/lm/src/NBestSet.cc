...
#ifndef lint
static char Copyright[] = "Copyright (c) 1998-2008 SRI International.  All Rights Reserved.";
static char RcsId[] = "@(#)$Header: /home/srilm/devel/lm/src/RCS/NBestSet.cc,v 1.9 2008/04/24 19:31:56 stolcke Exp $";
#endif
...
NBestSet::NBestSet(Vocab &vocab, RefList &refs,
    ...
    : vocab(vocab), refs(refs), maxNbest(maxNbest), incremental(incremental),
      multiChar(multiwords ? MultiwordSeparator : 0), warn(true)
{
}
