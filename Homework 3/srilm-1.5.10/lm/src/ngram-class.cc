...
#ifndef lint
static char Copyright[] = "Copyright (c) 1999-2009 SRI International.  All Rights Reserved.";
static char RcsId[] = "@(#)$Id: ngram-class.cc,v 1.29 2009/09/24 21:55:52 stolcke Exp $";
#endif
